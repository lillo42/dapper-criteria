...
{
    public class GreaterByExpressionValueExpression : IExpression
    {
        ...
        public GreaterByExpressionValueExpression(string column, IExpression expression, string @alias)
        {
