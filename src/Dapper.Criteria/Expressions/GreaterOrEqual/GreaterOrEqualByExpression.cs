...
{
    public class GreaterOrEqualByExpressionValueExpression : IExpression
    {
        ...
        public GreaterOrEqualByExpressionValueExpression(string column, IExpression expression, string @alias)
        {
